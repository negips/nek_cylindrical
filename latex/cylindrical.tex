...
\begin{subequations}
	\begin{eqnarray}
		...
		w_{R}	= (\mathcal{I}^{T}_{t12}\otimes\mathcal{D}^{T}_{s12}\otimes\mathcal{I}^{T}_{r12})(\dfrac{\partial s}{\partial y}.*R.*W.*p) \\
...
%		w_{2}	= (\mathcal{I}^{T}_{t12}\otimes\mathcal{D}^{T}_{s12}\otimes\mathcal{I}^{T}_{r12})(R.*W.*\dfrac{\partial s}{\partial y}.*p) \\
%		w_{3}	= (\mathcal{D}^{T}_{t12}\otimes\mathcal{I}^{T}_{s12}\otimes\mathcal{I}^{T}_{r12})(W.*\dfrac{\partial t}{\partial z}.*p)
	\end{eqnarray}
\end{subequations}
...
\begin{subequations}
	\begin{eqnarray}
		w_{R}	=& (\mathcal{I}^{T}_{t12}\otimes\mathcal{D}^{T}_{s12}\otimes\mathcal{I}^{T}_{r12})(\mathcal{I}_{2}\otimes\dfrac{\partial s}{\partial R}\otimes\mathcal{I}_{2})(\mathcal{I}_{2}\otimes R_{2}\otimes\mathcal{I}_{2})(W_{t2}\otimes W_{s2}\otimes W_{r2})p \\
